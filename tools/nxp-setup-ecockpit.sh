...
echo -e "ECOCKPIT_REVISION = \"ecockpit_06_03_rc1\"" >> $BUILD_DIR/conf/local.conf
...
echo -e "SRCREV_pn-u-boot-imx-a72 = \"ecockpit_android_06_03_rc1\"" >> $BUILD_DIR/conf/local.conf
